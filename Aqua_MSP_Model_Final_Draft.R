## Disclaimer 
# Install packages? 
install_packs <- T # Change to true if it is the first t loading the model
# Load necessary R packages 
if(install_packs == T){
   install.packages(c('TeachingDemos','maps','mapdata','maptools','scales','ggmap',
    'ggplot2','grid','GGally','gridExtra','jpeg','R.matlab','png','shape','DDHFm','tiff',
    'dplyr','csvread','httr','curl','plyr','XML','devtools'))
}
require(dplyr)
require(csvread)
require(lubridate)
...
# Load R package to manipulate MATLAB 
