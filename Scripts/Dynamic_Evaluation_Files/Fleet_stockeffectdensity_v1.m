function [should_be_zero1]=Fleet_stockeffectdensity_v1(x0_PPUE,habitat_area_i,theta,price,Bi_legal,delta, gamma, distance_to_port_for_each_soft_depth_patch,SQ_1fishable_0notfishable_for_each_soft_depth_patch,Fsum)
  ...
  % global Bi_legal price delta theta Fsum habitat_area_i gamma distance_to_port_for_each_soft_depth_patch SQ_1fishable_0notfishable_for_each_soft_depth_patch %qi
    % load(Tuner_parameters,habitat_area_i,theta,price,Bi_legal,delta, gamma, distance_to_port_for_each_soft_depth_patch,SQ_1fishable_0notfishable_for_each_soft_depth_patch,Fsum)
