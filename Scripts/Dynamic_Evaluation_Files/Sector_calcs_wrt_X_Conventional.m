function [P1,P2,P3,P4,P5,P6,P7,P1i,P2i,P3i,P4i,P5i,P6i,P7i,mussel_NPVi_tmp,mussel_NPV_tmp,Fish_NPVi_tmp,Fish_NPV_tmp,kelp_NPVi_tmp,kelp_NPV_tmp,Halibut_NPVi_tmp,Halibut_NPV_tmp,Halibut_NPV_scaled_tmp,Halibut_Yi_tmp,halibut_dynamic_scaled_tmp,Viewshed_raw_valuei_fin_tmp,Viewshed_raw_valuei_kelpmussel_tmp,Viewshed_raw_value_fin_tmp,Viewshed_raw_value_kelpmussel_tmp,enviro_impacti_tmp,enviro_impact_tmp,disease_rawi,disease_raw_sum]=Sector_calcs_wrt_X_Conventional(X,target_fid_fulldomain,Aqua_dev_indices,P1_full_scaled_obj,P2_full_scaled_obj,P3_full_scaled_obj,P4_aqua_patches_scaled_obj,Viewshed_impacts_finfish_scaled_obj,...
...
[~, ~, IB]=intersect(tmp2,target_fid_hab_depth); %find fid's in common with those that represent the halibut patches. IB=indices (not fid's) of the halibut patches that are developed by aqua dev
