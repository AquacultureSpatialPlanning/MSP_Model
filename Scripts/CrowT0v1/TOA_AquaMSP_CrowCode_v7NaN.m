...
% csvwrite('Raw_Impacts_2017_5_4.csv',Raw_Impacts_double)
%% Parameters
...
for i = 1:I
      disp(i)
      tmp = zeros(1,P);
      tabs = tabulate(Policy_i_a(i,:));
      tmp(:,tabs(:,1)') = tabs(:,2)';
      CW_results(i,:) = tmp;
end
save('~/MSP_Model/Scripts/CrowT0v1/CW_Results_Summary.mat','CW_results')
csvwrite('~/MSP_Model/Scripts/CrowT0v1/CW_Results_Summary.csv',CW_results);
