...
xlswrite(strcat(output_data_dir,'Model_CDFG_Y_patches.xlsx'),[block_kglandings_inpatches_sum2one_Rec_Com model_sumYi_in_each_block]);
xlswrite(strcat(output_data_dir,'Model_CDFG_Y_blocks.xlsx'),[PacCoastFisheryGIS_kglandings_by_block_Com_plus_Rec_sum2one model_block_sumyield_sum2one]);
