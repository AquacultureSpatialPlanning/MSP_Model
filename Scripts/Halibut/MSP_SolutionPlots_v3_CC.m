%Loads policy solutions (EF MSP plans of aqua development) and calculates sector payoffs in each patch
    ...
    Policy_i_a = Policy_i_a_tmp.C_C_obj_i + 1;
    ...
    save(strcat(DirPart,'/Output/Data/EFPayoff_i_a_X_CC.mat'),'EFPayoff_i_a_M','EFPayoff_i_a_F','EFPayoff_i_a_K','EFPayoff_i_a_H','EFPayoff_i_a_V','EFPayoff_i_a_B','EFPayoff_i_a_D','-v7.3');
...
%     load Y_NPV_wrt_MSP
    load(strcat(DirPart,'/Output/Data/CC_Dynamic_Halibut')) %contains Y_NPV_wrt_MSP
    ...
    save(strcat(DirPart,'/Output/Data/EFPayoff_a_X_wrt_DM_CC'),'EFPayoff_a_M_wrt_DM','EFPayoff_a_F_wrt_DM','EFPayoff_a_K_wrt_DM','EFPayoff_a_H_wrt_DM','EFPayoff_a_V_wrt_DM','EFPayoff_a_B_wrt_DM','EFPayoff_a_D_wrt_DM')
exit;
