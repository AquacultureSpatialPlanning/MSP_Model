...
tic %start timer
    ...
    load(strcat(DirPart,'/Output/Data/Policy_i_a_1.mat')) %1=ND; Greater than 1 = aqua devel
    load(strcat(DirPart,'/Output/Data/Policy_i_a_2.mat'))
    load(strcat(DirPart,'/Output/Data/Policy_i_a_3.mat'))
    Policy_i_a = cat(2,Policy_i_a_1,Policy_i_a_2,Policy_i_a_3) + 1;
    ...
    % save('MSP_Model/Output/Data/EFPayoff_i_a_X.mat','EFPayoff_i_a_M','EFPayoff_i_a_F','EFPayoff_i_a_K','EFPayoff_i_a_H','EFPayoff_i_a_V','EFPayoff_i_a_B','EFPayoff_i_a_D','-v7.3')
...
%     load Y_NPV_wrt_MSP
    load(strcat(DirPart,'/Output/Data/DynHalEval_wrt_MSP')) %contains Y_NPV_wrt_MSP
    ...
    save(strcat(DirPart,'/Output/Data/EFPayoff_a_X_wrt_DM_new.mat'),'EFPayoff_a_M_wrt_DM','EFPayoff_a_F_wrt_DM','EFPayoff_a_K_wrt_DM','EFPayoff_a_H_wrt_DM','EFPayoff_a_V_wrt_DM','EFPayoff_a_B_wrt_DM','EFPayoff_a_D_wrt_DM','-v7.3')
exit;
